...
document.getElementById("output_table_14");
...
const showAll = (data, err) => {
    ...
    doc = document.querySelector("#output_table_14");
...
function createTable(id, username, phoneno, department, date, checkUpdate) {
    var outputTable = document.getElementById('output_table_14');
