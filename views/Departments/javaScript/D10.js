...
document.getElementById("output_table_10");
...
const showAll = (data, err) => {
    ...
    doc = document.querySelector("#output_table_10");
...
function createTable(id, username, phoneno, department, date, checkUpdate) {
    var outputTable = document.getElementById('output_table_10');
