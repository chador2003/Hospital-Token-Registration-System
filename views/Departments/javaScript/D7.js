...
document.getElementById("output_table_7");
...
const showAll = (data, err) => {
    ...
    doc = document.querySelector("#output_table_7");
    for (let i = 0; i < lengthh; i++) {
        ...
        const id = feed._id;
        if (department === "Forensic Medicine") {
            console.log("Huiii!!!");
...
function createTable(id, username, phoneno, department, date, checkUpdate) {
    var outputTable = document.getElementById('output_table_7');
